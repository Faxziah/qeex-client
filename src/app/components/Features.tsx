          ...
          <div className="flex flex-col gap-16 md:gap-20 lg:gap-0 w-full max-w-6xl">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-2 md:gap-4 lg:gap-6">
              <div className="w-full lg:w-1/2 flex justify-center lg:justify-start">
                <div className="relative w-48 h-48 md:w-60 md:h-60 lg:w-72 lg:h-48">
                  <Image
              ...
              <div className="w-full lg:w-1/2 text-center lg:text-left">
                <h4
                  className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 relative inline-block group text-gray-900 dark:text-white">
                  <span
                    className="absolute -left-7 top-1/2 w-4 h-4 bg-blue-500 rounded-full transform -translate-y-1/2 group-hover:bg-[#B2EBF2] transition-colors"></span>
