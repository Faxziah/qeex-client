...
export default function ContractsType() {
  return (
    <div className="w-full py-0 md:py-16 lg:py-20">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="relative text-center mb-12 md:mb-16 lg:mb-10">
            ...
            <div className="relative z-10 pt-0">
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 xs:mb-6 text-center text-gray-900 dark:text-white">
                Смарт-контракты
              </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 md:gap-8 lg:gap-12 mt-12 md:mt-16">
            ...
            <div className="rounded-2xl md:rounded-3xl lg:rounded-[32px] bg-gradient-to-br from-cyan-200 via-blue-200 to-blue-300 p-8 md:p-10 lg:p-12 xl:p-[50px] flex flex-col items-center text-center xl:col-span-1">
            ...
            {/* Криптовалюта */}
            <div className="rounded-2xl md:rounded-3xl lg:rounded-[32px] bg-gradient-to-br from-pink-200 via-purple-200 to-purple-300 p-8 md:p-10 lg:p-12 xl:p-[50px] flex flex-col items-center text-center">
              <h4 className="text-xl md:text-2xl lg:text-3xl font-bold mb-4 md:mb-6 lg:mb-8 text-gray-800">
                Криптовалюта
              </h4>
              <p className="text-sm md:text-base lg:text-lg text-gray-700 mb-8 md:mb-12 lg:mb-16 leading-relaxed">
            ...
            {/* NFT-токен */}
            <div className="rounded-2xl md:rounded-3xl lg:rounded-[32px] bg-gradient-to-br from-cyan-200 via-blue-200 to-purple-200 p-8 md:p-10 lg:p-12 xl:p-[50px] flex flex-col items-center text-center lg:col-span-2 xl:col-span-1">
              <h4 className="text-xl md:text-2xl lg:text-3xl font-bold mb-4 md:mb-6 lg:mb-8 text-gray-800">
                NFT-токен
              </h4>
              <p className="text-sm md:text-base lg:text-lg text-gray-700 mb-8 md:mb-12 lg:mb-16 leading-relaxed">
